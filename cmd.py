...
"python learn_ltl_matrix.py -train_file=V2/Training_Set/5/training_1.json -test_file=V2/Training_Set/5/training_1.json -save_model=V2/Log/5/training_1.model -log_file=V2/Log/5/training_1.log -res_file=V2/Log/5/training_1.txt -epoch_num=80",
"python learn_ltl_matrix.py -train_file=V2/Training_Set/5/training_2.json -test_file=V2/Training_Set/5/training_2.json -save_model=V2/Log/5/training_2.model -log_file=V2/Log/5/training_2.log -res_file=V2/Log/5/training_2.txt -epoch_num=80",
"python learn_ltl_matrix.py -train_file=V2/Training_Set/5/training_3.json -test_file=V2/Training_Set/5/training_3.json -save_model=V2/Log/5/training_3.model -log_file=V2/Log/5/training_3.log -res_file=V2/Log/5/training_3.txt -epoch_num=80",
"python learn_ltl_matrix.py -train_file=V2/Training_Set/5/training_4.json -test_file=V2/Training_Set/5/training_4.json -save_model=V2/Log/5/training_4.model -log_file=V2/Log/5/training_4.log -res_file=V2/Log/5/training_4.txt -epoch_num=80",
"python learn_ltl_matrix.py -train_file=V2/Training_Set/5/training_5.json -test_file=V2/Training_Set/5/training_5.json -save_model=V2/Log/5/training_5.model -log_file=V2/Log/5/training_5.log -res_file=V2/Log/5/training_5.txt -epoch_num=80",
"python learn_ltl_matrix.py -train_file=V2/Training_Set/5/training_6.json -test_file=V2/Training_Set/5/training_6.json -save_model=V2/Log/5/training_6.model -log_file=V2/Log/5/training_6.log -res_file=V2/Log/5/training_6.txt -epoch_num=80",
"python learn_ltl_matrix.py -train_file=V2/Training_Set/5/training_7.json -test_file=V2/Training_Set/5/training_7.json -save_model=V2/Log/5/training_7.model -log_file=V2/Log/5/training_7.log -res_file=V2/Log/5/training_7.txt -epoch_num=80",
"python learn_ltl_matrix.py -train_file=V2/Training_Set/5/training_8.json -test_file=V2/Training_Set/5/training_8.json -save_model=V2/Log/5/training_8.model -log_file=V2/Log/5/training_8.log -res_file=V2/Log/5/training_8.txt -epoch_num=80",
"python learn_ltl_matrix.py -train_file=V2/Training_Set/5/training_9.json -test_file=V2/Training_Set/5/training_9.json -save_model=V2/Log/5/training_9.model -log_file=V2/Log/5/training_9.log -res_file=V2/Log/5/training_9.txt -epoch_num=80",
"python learn_ltl_matrix.py -train_file=V2/Training_Set/5/training_10.json -test_file=V2/Training_Set/5/training_10.json -save_model=V2/Log/5/training_10.model -log_file=V2/Log/5/training_10.log -res_file=V2/Log/5/training_10.txt -epoch_num=80"
...
90-10 的 5秒 VAT 解析
"python matrix2ltl.py -train_file=V2/Training_Set/5/training_1.json -test_file=V2/Training_Set/5/test_1.json -save_model=V2/Log/5/training_1.model -top_num=100",
"python matrix2ltl.py -train_file=V2/Training_Set/5/training_2.json -test_file=V2/Training_Set/5/test_2.json -save_model=V2/Log/5/training_2.model -top_num=100",
"python matrix2ltl.py -train_file=V2/Training_Set/5/training_3.json -test_file=V2/Training_Set/5/test_3.json -save_model=V2/Log/5/training_3.model -top_num=100",
"python matrix2ltl.py -train_file=V2/Training_Set/5/training_4.json -test_file=V2/Training_Set/5/test_4.json -save_model=V2/Log/5/training_4.model -top_num=100",
"python matrix2ltl.py -train_file=V2/Training_Set/5/training_5.json -test_file=V2/Training_Set/5/test_5.json -save_model=V2/Log/5/training_5.model -top_num=100",
"python matrix2ltl.py -train_file=V2/Training_Set/5/training_6.json -test_file=V2/Training_Set/5/test_6.json -save_model=V2/Log/5/training_6.model -top_num=100",
"python matrix2ltl.py -train_file=V2/Training_Set/5/training_7.json -test_file=V2/Training_Set/5/test_7.json -save_model=V2/Log/5/training_7.model -top_num=100",
"python matrix2ltl.py -train_file=V2/Training_Set/5/training_8.json -test_file=V2/Training_Set/5/test_8.json -save_model=V2/Log/5/training_8.model -top_num=100",
"python matrix2ltl.py -train_file=V2/Training_Set/5/training_9.json -test_file=V2/Training_Set/5/test_9.json -save_model=V2/Log/5/training_9.model -top_num=100",
"python matrix2ltl.py -train_file=V2/Training_Set/5/training_10.json -test_file=V2/Training_Set/5/test_10.json -save_model=V2/Log/5/training_10.model -top_num=100"
