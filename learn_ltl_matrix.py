...
if __name__ == '__main__':
    ...
    # lr=1e-4
    # l1=0.1
    train(train_file=args.train_file, formula_len=args.network_len, save_name=args.save_model, epoch_num=args.epoch_num, log_file=args.log_file,learn_rate=args.lr,l1_cof=args.l1)
    _, word2idx, vocab = get_data(args.train_file, args.network_len)
    test(test_file=args.test_file,formula_len=args.network_len,word2idx=word2idx,vocab=vocab,model_file=args.save_model,save_file=args.res_file)
